...
const SubjectIcon = ({ name, className = 'w-5 h-5' }: { name: string; className?: string }) => {
  const iconMap: Record<string, JSX.Element> = {
    ...
    'General Mathematics': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>,
    ...
    'Financial Accounting': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>,
    ...
    'Islamic Studies': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>,
    ...
    'Data Processing': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg>,
    'Office Practice': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>,
    'Further Mathematics': <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>,
  };
  return iconMap[name] || <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" /></svg>;
};

const subjects = [
  { name: 'English Language', questions: 350 },
  { name: 'General Mathematics', questions: 300 },
  { name: 'Biology', questions: 280 },
  { name: 'Physics', questions: 260 },
  { name: 'Chemistry', questions: 260 },
  { name: 'Economics', questions: 240 },
  { name: 'Government', questions: 220 },
  { name: 'Literature', questions: 200 },
  { name: 'Commerce', questions: 190 },
  { name: 'Financial Accounting', questions: 180 },
  { name: 'Geography', questions: 170 },
  { name: 'Agricultural Science', questions: 160 },
  { name: 'Computer Studies', questions: 150 },
  { name: 'Civic Education', questions: 140 },
  { name: 'History', questions: 130 },
  { name: 'Christian Religious Studies', questions: 120 },
  { name: 'Islamic Studies', questions: 110 },
  { name: 'Marketing', questions: 100 },
  { name: 'French', questions: 90 },
  { name: 'Data Processing', questions: 85 },
  { name: 'Office Practice', questions: 80 },
  { name: 'Further Mathematics', questions: 75 },
];

const features = [
  {
    title: 'Complete Coverage',
    description: 'All WAEC/SSCE subjects with comprehensive past question bank.',
    icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
  },
  {
    title: 'Exam Mode',
    description: 'Practice under timed conditions like the real WAEC exam.',
    ...
    <>
      ...
      <main className="pt-28 pb-16 md:pt-36 md:pb-24">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl text-neutral-700 mb-8">
                  ...
                  Master your exams with comprehensive practice materials.
                </p>
              ...
              <div className="relative">
                ...
                <div className="bg-white rounded-3xl p-6 text-center shadow-xl">
                  <p className="text-4xl font-bold text-accent-500">3,500+</p>
                  <p className="text-neutral-600 mt-1">Past Questions</p>
                </div>
                <div className="bg-white rounded-3xl p-6 text-center shadow-xl">
                  <p className="text-4xl font-bold text-primary-500">22+</p>
                  <p className="text-neutral-600 mt-1">Subjects</p>
                </div>
                <div className="bg-white rounded-3xl p-6 text-center shadow-xl">
                  <p className="text-4xl font-bold text-success-500">250K+</p>
        ...
        <div className="section-container mb-16">
          <h2 className="text-3xl font-display font-bold text-center mb-12">Why practice WAEC with ExamScholars?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => (
              <div key={feature.title} className="bg-white rounded-3xl p-6 text-center">
                <div className="w-14 h-14 bg-accent-100 rounded-2xl flex items-center justify-center text-accent-600 mx-auto mb-4">
                  {feature.icon}
                </div>
        ...
        <div className="section-container">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {subjects.map((subject) => (
              <div
                key={subject.name}
                className="bg-white rounded-2xl p-5 border-2 border-neutral-100 hover:border-accent-300 hover:shadow-lg transition-all cursor-pointer"
              >
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 bg-accent-100 rounded-xl flex items-center justify-center">
                    <SubjectIcon name={subject.name} className="w-5 h-5 text-accent-600" />
                  </div>
                  <div>
