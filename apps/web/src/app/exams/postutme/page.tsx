              ...
              <div>
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center overflow-hidden">
                    <img src="/images/post utme.webp" alt="Post-UTME Logo" className="w-14 h-14 object-contain" />
                  </div>
              ...
              <div className="relative">
                ...
                <div className="relative grid grid-cols-2 gap-4">
                  ...
                  <div className="bg-white rounded-3xl p-6 text-center shadow-xl relative overflow-hidden">
                    <img src="/images/post utme.webp" alt="" className="absolute -bottom-4 -right-4 w-24 h-24 object-contain opacity-10" />
